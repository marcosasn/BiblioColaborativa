...
public class TestaUsuario { 
    ...
    public void testaConstrutorUsuario() throws Exception { 
        ...
        try {
			new Usuario("marcos123", "1234567", "marcosasn@gmail.com",
					"Rua Santo Antonio 260, Centro");
			Assert.fail("Esperava excessao.");
		} catch (Exception e) {
			Assert.assertEquals("paramentros incorretos",
					e.getMessage());
		}
        ...
        try { 
            new Usuario("Marcos", null, "marcosasn", 
                    "Rua Santo Antonio 260, Centro"); 
            Assert.fail("Esperava excessao."); 
        } catch (Exception e) { 
            Assert.assertEquals("senha nao pode ser vazio ou nulo", 
        ...
        try { 
            new Usuario("Marcos", "123", "marcosasn", 
                    "Rua Santo Antonio 260, Centro"); 
            Assert.fail("Esperava excessao."); 
        } catch (Exception e) { 
